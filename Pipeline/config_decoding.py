...
#I was wrong, some subjects do need the full 2 second window
#epochs_tmin: float = -2
#epochs_tmax: float = 2
epochs_tmin: float = -1
epochs_tmax: float = 2
...
ica_ecg_threshold: float = 0.08 #lowered because some participants have no EOG related ICs detected
# """
...
contrasts: Sequence[tuple[str, str] | ArbitraryContrast] = [('ODDBALL RARE', 'ODDBALL STANDARD'), ('GAMBLING WIN', 'GAMBLING LOSS')]
...
#makes sense because we have very unbalanced classes for oddball and gamble
decoding_metric: str = "roc_auc"


#too complicated, also we are not really interested in the temporal behavior anyway
#decoding_time_generalization: bool = False
decoding_time_generalization: bool = True

# Sounds interesting, but might be too complicated for our purposes
# We are not specifically interested in analyzing the reactions on certain
# power bands or time bins 
...
n_jobs: int = os.cpu_count()-2 #minus two to allow smooth operation of the computer
# """
